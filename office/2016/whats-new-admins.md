...
This article is intended to highlight the new features and capabilities of Office 2016 that admins might want to know about as they plan to deploy Office 2016 to the users in their organization.
...
With any new software release, you should [review the system requirements](https://support.microsoft.com/topic/5e59b928-c35c-4b7f-806d-8b44c23d2eb9#bkmk_o16comm) to ensure that your computers meet those requirements. For example, for Office 2016, the minimum requirement is now 2 GB of RAM. 
...
## Outlook 2016 adds support for multifactor authentication (MFA)

Multifactor authentication (MFA) is now available in Outlook through integration with the Microsoft Authentication Library.
