...
|---------------------------|---------------------------------------|---------------------------------------------------------------------------------------------|
| Commercial and GCC        | Microsoft 365 Apps admin center       | <li>login.live.com</li><li>`*.office.com`</li><li>`*.office.net`</li><li>`*.config.office.com`</li><li>`*.config.office.net`</li> |
